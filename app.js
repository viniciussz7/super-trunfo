...
var cartaRafa = {
    nome: "Bulbassauro",
    imagem: "https://static.pokemonpets.com/images/monsters-images-300-300/1-Bulbasaur.png",
    atributos: {
        ataque: 70,
        defesa: 65,
        magia: 85
...
function jogar() {
    ...
    if (cartas.length == 0) {
        ...
        if (pontosJogador > pontosMaquina) {
            htmlResultado = '<p class="resultado-final">WINNER</p>'
        } else if (pontosJogador < pontosMaquina) {
            htmlResultado = '<p class="resultado-final">LOSER</p>'
        } else {
